 ...
 */
public abstract class OverScrollScaleEffectDecoratorBase implements IOverScrollDecor, View.OnTouchListener {
    ...
    protected class IdleState implements IDecoratorState {
        ...
        public void handleEntryTransition(IDecoratorState fromState) {
            mStateListener.onOverScrollStateChange(OverScrollScaleEffectDecoratorBase.this, fromState.getStateId(), this.getStateId());
        }
    }
    ...
    protected class OverScrollingState implements IDecoratorState {
        ...
        public boolean handleMoveTouchEvent(MotionEvent event) {
            ...
            if ((mStartAttr.mDir && !mMoveAttr.mDir && (newOffset <= mStartAttr.mAbsOffset)) ||
                ...
                scaleViewAndEvent(view, mStartAttr.mAbsOffset, event);
                mUpdateListener.onOverScrollUpdate(OverScrollScaleEffectDecoratorBase.this, mCurrDragState, 0);
            ...
            scaleView(view, newOffset);
            mUpdateListener.onOverScrollUpdate(OverScrollScaleEffectDecoratorBase.this, mCurrDragState, newOffset);
    ...
    protected class BounceBackState implements IDecoratorState, Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
        ...
        protected final Interpolator mBounceBackInterpolator = new OvershootInterpolator();
...
//            issueStateTransition(mIdleState);
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            mUpdateListener.onOverScrollUpdate(OverScrollScaleEffectDecoratorBase.this, STATE_BOUNCE_BACK, (Float) animation.getAnimatedValue());
        }
        ...
        protected Animator createAnimator() {
            ...
            return createBounceBackAnimator(slowdownEndOffset);
        }
        ...
        protected ObjectAnimator createBounceBackAnimator(float startOffset) {
            ...
            ObjectAnimator bounceBackAnim = ObjectAnimator.ofFloat(view, mAnimAttributes.mProperty, 1);
    ...
    public OverScrollScaleEffectDecoratorBase(IOverScrollDecoratorAdapter viewAdapter, float decelerateFactor, float touchDragRatioFwd, float touchDragRatioBck) {
    ...
    protected abstract void scaleView(View view, float offset);

    protected abstract void scaleViewAndEvent(View view, float offset, MotionEvent event);
}
